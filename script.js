var pagedata=[
  ...
  var id1=document.getElementById("1id") 
...
var prev=[];
  ...
  loaddata();
  function loaddata(){
  for(currentcount=initialcount;currentcount<endcount;currentcount++){
  var row=mytable.insertRow();
  var cell1=row.insertCell();
  var cell2=row.insertCell();
  var cell3=row.insertCell();
  cell1.innerText=pagedata[currentcount].id
  cell2.innerText=pagedata[currentcount].name
  cell3.innerText=pagedata[currentcount].email
...
btnf.addEventListener("click",()=>{
  DeleteRows()
  initialcount=0;endcount=10;
  prev.push(initialcount)
  console.log(prev)
  loaddata();
 })
  ...
  btn2.addEventListener("click",()=>{
   ...
   btnp.addEventListener("click",()=>{
    ...
    initialcount=prev[(prev.length)-1]-10;
    endcount=initialcount+10;
    console.log(initialcount,endcount)
    loaddata(); }
   })